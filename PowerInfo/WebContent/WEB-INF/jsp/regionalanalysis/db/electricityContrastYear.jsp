...
var cols = [ [  {
	...
	function queryData() {
		...
		var url = path+'/electricityContrastDbYearController/queryData';
	...
	function ExportExcel() {//导出Excel文件
		...
		var f = $('<form action="'+path+'/electricityContrastDbYearController/exportData" method="post" id="fm1"></form>');  
