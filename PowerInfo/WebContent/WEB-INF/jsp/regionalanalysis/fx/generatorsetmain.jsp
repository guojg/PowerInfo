...
<script type="text/javascript">
	...
	$(function() {
		...
		//加载选项卡页面
		var srcs = {
				'基本信息' : path+'/constantCostFxArgController/index?id='+id+'&task_id='+task_id+'&plant_id='+plant_id,
				'燃煤成本' : path+'/coalCostfx/main?fdj_id='+id+'&task_id='+task_id+'&plant_id='+plant_id
		};
