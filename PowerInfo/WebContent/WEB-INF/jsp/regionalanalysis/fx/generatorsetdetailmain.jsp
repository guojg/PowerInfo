...
<script type="text/javascript">
	...
	$(function() {
		...
		//加载选项卡页面
		var srcs = {
				'基本信息' : path+'/constantCostFxArgController/detail?id='+id+'&task_id='+task_id+'&plant_id='+plant_id,
				'燃煤成本' : path+'/coalCostfx/detail?fdj_id='+id+'&task_id='+task_id+'&plant_id='+plant_id
		};
