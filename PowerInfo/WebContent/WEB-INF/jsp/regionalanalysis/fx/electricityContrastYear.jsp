...
var cols = [ [  {
	...
	function queryData() {
		...
		var url = path+'/electricityContrastFxYearController/queryData';
	...
	function ExportExcel() {//导出Excel文件
		...
		var f = $('<form action="'+path+'/electricityContrastFxYearController/exportData" method="post" id="fm1"></form>');  
