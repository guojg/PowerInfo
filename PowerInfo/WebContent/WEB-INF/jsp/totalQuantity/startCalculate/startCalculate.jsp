...
<body>
	...
	产值单耗法:
		...
		<p class="p2">
			预测年一产GDP*预测年一产单耗（即：基准年一产单耗*一产单耗增长率）+
			</p>
	 		<p class="p2">预测年二产GDP*预测年二产单耗（即：基准年二产单耗*二产单耗增长率）+</p>
	               <p class="p2"> 预测年三产GDP*预测年三产单耗（即：基准年三产单耗*三产单耗增长率）+</p>
	            <p class="p2">  预测年居民生活用电量（即基准年居民生活用电量*居民生活用电量增长率）</p>
