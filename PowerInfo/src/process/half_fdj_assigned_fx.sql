...
DELETE FROM shiro.constant_cost_arg_fx  WHERE index_type IN(10001,11001,12001,13001) AND jz_id IN(SELECT  jz_id FROM constant_cost_arg_fx WHERE  index_type=200 AND index_value=fdc_id_arg AND task_id=task_id_arg);
-- 获取机组在电厂下有几个机组
