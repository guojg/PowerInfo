	...
	public List<Map<String, Object>> queryMenu(JSONObject param) {
		...
		StringBuffer sb = new StringBuffer();
		 ...
		 this.jdbcTemplate.execute(   
			...
			sb.append( "      SELECT sys_menu.id,sys_menu.name text,sys_menu.p_id parent_id,sys_menu.useful,sys_menu.unit_code,sys_menu.url,sys_menu.table_name tablename FROM tmpLst,shiro.sys_menu WHERE tmpLst.id=shiro.sys_menu.id ORDER BY tmpLst.sno") ;
