...
import com.github.regionalanalysis.fx.electricitycontrastyear.dao.ElectricityContrastFxYearDao;

import net.sf.json.JSONObject;

@Service
public class ElectricityContrastFxYearServiceImpl implements  ElectricityContrastFxYearService{

	@Autowired
	private ElectricityContrastFxYearDao electricityContrastFxYearDao;

	@Override
	public String queryData(JSONObject param) {
		List<Map<String, Object>> list = electricityContrastFxYearDao.queryData(param);
