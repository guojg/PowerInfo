...
import com.github.regionalanalysis.fx.electricitycontrast.dao.ElectricityContrastFxDao;

import net.sf.json.JSONObject;

@Service
public class ElectricityContrastFxServiceImpl implements  ElectricityContrastFxService{

	@Autowired
	private ElectricityContrastFxDao electricityContrastFxDao;

	@Override
	public String queryData(JSONObject param) {
		List<Map<String, Object>> list = electricityContrastFxDao.queryData(param);
