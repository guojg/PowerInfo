...
import com.github.regionalanalysis.fx.generatorcontrast.dao.GeneratorContrastFxDao;

import net.sf.json.JSONObject;

@Service
public class GeneratorContrastFxServiceImpl implements  GeneratorContrastFxService{

	@Autowired
	private GeneratorContrastFxDao generatorContrastFxDao;

	@Override
	public String queryData(JSONObject param) {
		List<Map<String, Object>> list = generatorContrastFxDao.queryData(param);
