...
@Repository
public class ConstantCostFxArgDaoImpl implements ConstantCostFxArgDao {
	...
	public String save(final List<ConstantCostArg> list) {
		String deleteSql = "delete from constant_cost_arg_fx where jz_id=? and task_id=? and index_type not IN(10001,11001,12001,13001,17002,17003,17004,17005) " ;
