package com.github.regionalanalysis.fx.constantcostarg.service;
...
@Service
public class ConstantCostFxArgServiceImpl implements ConstantCostFxArgService {
	...
	public String  saveData(Map m,String organ,String taskid) {
		...
		String result = constantCostFxArgDao.save(list);
	...
	public String initData(String id,String task_id) {
		List<ConstantCostArg> list = constantCostFxArgDao.getDataById(id,task_id);
		JSONObject obj = new JSONObject();
	...
	public String getPlant(String area_id,String task_id) {
		List<Map<String, Object>>   list =  constantCostFxArgDao.queryPlant(area_id,task_id);
