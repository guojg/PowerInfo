...
import com.github.regionalanalysis.db.generatorset.dao.GeneratorSetDbDao;
...
@Service
public class GeneratorSetDbServiceImpl implements GeneratorSetDbService {

	@Autowired
	private GeneratorSetDbDao generatorSetDbDao;

	
	@Override
	public String queryData(JSONObject param) {
		List<Map<String, Object>> list = generatorSetDbDao.queryData(param);
		int count = generatorSetDbDao.queryDataCount(param);
	...
	public void ExportExcel(JSONObject param, HttpServletResponse response)
		...
		List<Map<String, Object>> list = generatorSetDbDao.queryAllData(param);
	...
	public void deleteData(JSONObject obj) {
		String delectArr[] = obj.get("deleteids") == null ? null : obj
		 ...
		 generatorSetDbDao.deleteData(delectArr);
