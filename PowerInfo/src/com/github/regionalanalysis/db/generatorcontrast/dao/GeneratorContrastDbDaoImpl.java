...
public class GeneratorContrastDbDaoImpl implements GeneratorContrastDbDao {
	...
	public List<Map<String, Object>> queryData(JSONObject param) {
		...
		.append("			MAX(CASE j.index_type WHEN 200 THEN j.index_value END) 'dc_id' FROM constant_cost_arg j  WHERE j.index_type IN(100,200) and j.task_id=? GROUP BY task_id,jz_id")
		.append(" 				) jz JOIN electricpowerplant_analysis_data dc  	 ON jz.dc_id =dc.id  and jz.task_id=dc.task_id ") ;
		String InSql = "";
