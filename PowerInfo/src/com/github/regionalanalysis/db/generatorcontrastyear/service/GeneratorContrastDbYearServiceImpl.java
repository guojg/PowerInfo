...
import com.github.regionalanalysis.db.generatorcontrastyear.dao.GeneratorContrastDbYearDao;

import net.sf.json.JSONObject;

@Service
public class GeneratorContrastDbYearServiceImpl implements  GeneratorContrastDbYearService{

	@Autowired
	private GeneratorContrastDbYearDao generatorContrastDbYearDao;

	@Override
	public String queryData(JSONObject param) {
		List<Map<String, Object>> list = generatorContrastDbYearDao.queryData(param);
