package com.github.regionalanalysis.db.coalcost.controller;
...
import com.github.regionalanalysis.db.coalcost.service.CoalCostDbService;

@Controller
@RequestMapping(value = "/coalCostdb")
public class CoalCostDbController {
	@Autowired
	private CoalCostDbService coalCostDbService;
	...
	public void queryData(HttpServletRequest request,
		...
		try {
			String resultJson = coalCostDbService.queryData(obj);
	...
	String saveData(HttpServletRequest request) {
		try {
			...
			coalCostDbService.saveData(jsonobj);
			return "1";
		} catch (Exception e) {
			e.printStackTrace();
			return "0";
	...
	public String index(Long pid, HttpServletRequest request,
		...
		return "regionalanalysis/db/CoalCost";
	}
	
	@RequestMapping(value = "/detail")
	public String detail(Long pid, HttpServletRequest request,
			HttpServletResponse re) {
		return "regionalanalysis/db/CoalCostDetail";
	}
	...
	public void exportData(HttpServletRequest request,
			...
			try {
				coalCostDbService.ExportExcel(obj, response);
			}catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
